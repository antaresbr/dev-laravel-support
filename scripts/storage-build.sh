...
[ -h "${APP_DIR}/public/storage" ] && [ ! -f "${APP_DIR}/public/storage" ] && rm "${APP_DIR}/public/storage"
[ -e "${APP_DIR}/public/storage" ] || sudo --user="${pOwner}" ln -s "../storage/app/public" "${APP_DIR}/public/storage"
