...
[ -z "${SAIL_SERVICE_APP_USER}" ] && SAIL_SERVICE_APP_USER="${SAIL_USERNAME}"
[ -z "${SAIL_SERVICE_ASYNC_USER}" ] && SAIL_SERVICE_ASYNC_USER="${SAIL_USERNAME}"
...
export SAIL_SERVICE_APP_USER

export SAIL_SERVICE_ASYNC="${COMPOSE_PROJECT_NAME}-async"
export SAIL_SERVICE_ASYNC_USER
